...
from app.middleware import get_cors_middleware, add_security_headers, limit_request_size
from app.db_mongo import initialize_database, close_connection
from app.db_assignments import create_assignment_indexes
from app.routes_chat import router as chat_router
from app.routes_assignments import router as assignments_router
from app.routes_admin import router as admin_router  # Make sure this is imported
